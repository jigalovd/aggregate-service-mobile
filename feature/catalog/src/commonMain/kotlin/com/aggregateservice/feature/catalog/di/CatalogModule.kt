...
import com.aggregateservice.feature.catalog.data.repository.LocationRepositoryImpl
...
val catalogModule =
    module {
        ...
        single<LocationRepository> { LocationRepositoryImpl(get(named("location"))) }

        // Location cache — presentation singleton, delegates persistence to LocationRepository
