...
class GetProviderServicesUseCaseTest {
    ...
    @Test
    fun `should return services on successful fetch`() = runTest {
    ...
    @Test
    fun `should return empty list when provider has no services`() = runTest {
    ...
    @Test
    fun `should pass categoryId to repository for filtering`() = runTest {
    ...
    @Test
    fun `should return services with all properties`() = runTest {
        val services = listOf(
            Service(
                id = "service-1",
    ...
    @Test
    fun `should return services with computed properties`() = runTest {
        val service = Service(
            id = "service-1",
            providerId = "provider-1",
            categoryId = "cat-1",
    ...
    @Test
    fun `should return filtered services when categoryId is provided`() = runTest {
        val filteredServices = listOf(
            Service(
                id = "service-1",
                providerId = "provider-1",
                categoryId = "cat-1",
    ...
    fun `should return network error when repository fails with network error`() = runTest {
        mockRepository.servicesResult = Result.failure(
    ...
    @Test
    fun `price should format correctly`() = runTest {
        val service = Service(
            id = "service-1",
            providerId = "provider-1",
            categoryId = "cat-1",
        ...
        assertEquals("150 ILS", result.getOrNull()!!.first().price.formatted)
    }

    @Test
    fun `price should calculate amountInCents correctly`() = runTest {
