...
class GetCategoriesUseCaseTest {
    ...
    @Test
    fun `should return categories on successful fetch`() =
        runTest {
    ...
    @Test
    fun `should pass parentId to repository`() =
        runTest {
    ...
    @Test
    fun `should pass null parentId for root categories`() =
        runTest {
            mockRepository.categoriesResult = Result.success(emptyList())
    ...
    @Test
    fun `should return subcategories when parentId is provided`() =
        runTest {
            val subcategories =
                listOf(
    ...
    @Test
    fun `getRootCategories should call repository with null parentId`() =
        runTest {
            val rootCategories =
                listOf(
    ...
    @Test
    fun `should return categories with correct properties`() =
        runTest {
            val categories =
                listOf(
                    Category(
    ...
    fun `should return network error when repository fails with network error`() =
        runTest {
            mockRepository.categoriesResult =
                Result.failure(
    ...
    @Test
    fun `should return not found error when repository fails`() =
        runTest {
    ...
    @Test
    fun `should return unknown error when repository throws unexpected exception`() =
        runTest {
    ...
    @Test
    fun `category isRootCategory should return true when parentId is null`() =
        runTest {
    ...
    @Test
    fun `category isRootCategory should return false when parentId is set`() =
        runTest {
