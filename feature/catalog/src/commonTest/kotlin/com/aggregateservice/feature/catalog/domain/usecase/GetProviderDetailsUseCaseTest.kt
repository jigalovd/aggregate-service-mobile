...
class GetProviderDetailsUseCaseTest {
    ...
    @Test
    fun `should return provider on successful fetch`() =
        runTest {
    ...
    @Test
    fun `should return provider with all properties`() =
        runTest {
            val provider =
                Provider(
                    id = "provider-1",
    ...
    @Test
    fun `should return provider with computed properties`() =
        runTest {
            val provider =
                Provider(
                    id = "provider-1",
    ...
    @Test
    fun `should use logoUrl as primaryPhotoUrl when photos list is empty`() =
        runTest {
            val provider =
                Provider(
                    id = "provider-1",
    ...
    @Test
    fun `should return unauthorized error when user is not authorized`() =
        runTest {
