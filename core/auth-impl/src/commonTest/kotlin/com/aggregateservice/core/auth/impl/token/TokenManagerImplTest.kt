...
class TokenManagerImplTest {
    ...
    @Test
    fun `getAccessToken returns null initially`() =
        runTest {
            assertNull(tokenManager.getAccessToken())
        }

    @Test
    fun `setTokens saves token and updates flow`() =
        runTest {
    ...
    @Test
    fun `clearTokens removes token and updates flow`() =
        runTest {
            tokenManager.setTokens("test-token")
    ...
    @Test
    fun `observeToken emits token updates`() =
        runTest {
    ...
    @Test
    fun `setTokens persists to storage`() =
        runTest {
            tokenManager.setTokens("test-token")
    ...
    @Test
    fun `initFromStorage loads token from storage`() =
        runTest {
    ...
    @Test
    fun `initFromStorage with null storage sets null`() =
        runTest {
